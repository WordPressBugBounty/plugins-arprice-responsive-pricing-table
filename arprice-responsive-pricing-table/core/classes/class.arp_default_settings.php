...
class arplite_default_settings {
	...
	function arp_footer_section_template_types() {
		...
		$arplite_footer_sec_temp_types = apply_filters(
			'arplite_footer_sec_temp_types',
			array(
				'type_1' => array(),
	...
	function arp_color_skin_template_types() {
		...
		$arp_color_skin_template_types = apply_filters(
			'arplite_color_skin_temp_types',
			array(
	...
	function arplite_exclude_caption_column_for_color_skin() {
		$arplite_exclude_caption_column_for_color_skin = apply_filters(
			'arplite_exclude_caption_column_for_color_skin',
			array(
	...
	function arp_column_section_background_color() {
		$arp_col_sec_bg_color = apply_filters(
			'arp_col_sec_bg_col',
			array(
	...
	function arp_template_bg_section_classes() {
		...
		$arp_template_bg_sec_classes = apply_filters(
			'arplite_tmp_bg_sec_classes',
			array(
				'arplitetemplate_7'  => array(
	...
	function arp_border_color() {
		...
		$arp_border_color = apply_filters(
			'arplite_border_colors',
			array(
				'arplitetemplate_1' => array(
					'caption_column' => array(
	...
	function arp_template_sections_array() {
		...
		$arptemplatesectionsarray = apply_filters(
			'arplitetemplate_available_sections_array',
			array(
				'arplitetemplate_7'  => array(
	...
	function arplite_template_custom_skin_array() {
		$arplite_template_custom_skin_array = apply_filters(
			'arplite_template_custom_skin_array',
			array(
				'arplitetemplate_7'  => array(
	...
	function arp_template_hover_class_array() {
		$arplitetemplatehoverclassarray = apply_filters(
			'arplitetemplatehoverclassarray',
			array(
				'arplitetemplate_7'  => array(
	...
	function arplite_default_gradient_templates() {
		$arplite_default_gradient_templates = apply_filters(
			'arplite_default_gradient_templates',
			array(
				'default_only' => array(),
				'all_skins'    => array(),
			)
	...
	function arp_default_rgba_color_array() {
		$arp_rgba_color_codes = apply_filters(
			'arplite_default_rgba_colors',
			array(
				'arplitetemplate_7' => array(
					'header_background_color' => array(
	...
	function arplite_default_skin_luminosity() {
		$arplite_default_skin_luminosity = apply_filters(
			'arplite_default_skin_luminosity',
			array(
				'arplitetemplate_7'  => array(),
				'arplitetemplate_2'  => array(),
				'arplitetemplate_1'  => array(),
	...
	function arplite_depended_section_color_codes() {
		$arplite_depended_section_color_code = apply_filters(
			'arplite_depended_section_color_code',
			array(
				'arplitetemplate_7'  => array(),
				'arplitetemplate_2'  => array(),
				'arplitetemplate_1'  => array(),
	...
	function arp_custom_skin_selection_section_color() {
		$arplite_custom_skin_selection_color = apply_filters(
			'arplite_custom_skin_selection_color',
			array(
	...
	function arplite_custom_css_selected_bg_color() {
		$arplite_custom_css_selected_bg_color = apply_filters(
			'arplite_custom_css_selected_bg_color',
			array(
	...
	function arp_background_image_section_array() {
		...
		$arplite_global_bg_image_section = apply_filters(
			'arplite_global_bg_image_section',
			array(
				'arplitetemplate_7'  => array(),
				'arplitetemplate_2'  => array(),
				'arplitetemplate_1'  => array(),
	...
	function arprice_default_template_skins( $post = array() ) {
		$arprice_default_template_skins = apply_filters(
			'arpricelite_default_template_skins_filter',
			array(
				'arplitetemplate_7'  => array(
	...
	function arp_change_default_template_skins( $default_array, $post, $general_options = array() ) {
		...
		$tableid   = isset( $post['table_id'] ) ? intval( $post['table_id'] ) : '';
		$reference = isset( $post['reference_template'] ) ? sanitize_text_field( $post['reference_template'] ) : '';
		...
		if ( $action == 'arprice_default_template_skins' ) {
			$query = $wpdb->get_results( $wpdb->prepare( 'SELECT * FROM ' . $wpdb->prefix . 'arplite_arprice WHERE ID=%d', $tableid ) );
		}
	...
	function arplite_css_pseudo_elements_array() {
		$arplite_css_pseudo_elements = apply_filters(
			'arplite_css_pseudo_elements',
	...
	function arprice_responsive_width_array() {
		...
		$arp_responsive_width_array = apply_filters(
			'arplite_responsive_widths',
			array(
				'arplitetemplate_7'  => array(
					'with_space' => array( '23%' ),
					'no_space'   => array( '25%' ),
	...
	function arpricelite_allow_border_radius() {
		...
		$arpricelite_allow_border_radius = apply_filters(
			'arpricelite_allow_border_radius',
			array(
	...
	function arp_border_bottom() {
		...
		$arp_border_bottom_hide_footer = apply_filters(
			'arplite_hide_footer_border_bottom',
			array(
				'arplitetemplate_1' => array(
					'caption_column' => array(
	...
	function arprice_column_wrapper_height() {
		$arprice_col_wrapper_height = apply_filters(
			'arpricelite_set_column_wrapper_height',
			array(
	...
	function arp_section_text_alignment() {
		$arplite_section_text_alignment = apply_filters(
			'arplite_section_text_alignment',
			array(
				'arplitetemplate_7'  => array(
					'other_column' => array(
						'header_section'             => 'arppricetablecolumntitle',
	...
	function arprice_hide_section_array() {
		$arprice_hide_section_array = apply_filters(
			'arprice_hide_section_array',
			array(
				'arplitetemplate_7'  => array(
	...
	function arprice_min_height_with_section_hide() {
		$arprice_min_height_with_section_hide = apply_filters(
			'arprice_min_height_with_section_hide',
			array(
				'arplitetemplate_7'  => array(
					'arp_header'           => '',
	...
	function arp_column_border_array() {
		$arp_column_border_array = apply_filters(
			'arp_column_border_array',
			array(
				'arplitetemplate_7'  => array(
	...
	function arp_font_settings() {
		$arp_font_settings = apply_filters(
			'arp_font_settings',
			array(
	...
	function arp_row_level_border() {
		...
		$arp_row_level_border = apply_filters(
			'arp_row_level_border',
			array(
	...
	function arp_exclude_caption_column_for_color_skin() {
		$arp_exclude_caption_column_for_color_skin = apply_filters(
			'arp_exclude_caption_column_for_color_skin',
			array(
				'arplitetemplate_1'  => false,
				'arplitetemplate_2'  => false,
				'arplitetemplate_7'  => false,
	...
	function arp_select_previous_skin_for_multicolor() {
		...
		$arp_select_previous_skin_for_multicolor = apply_filters(
			'arp_select_previous_skin_for_multicolor',
			array(
	...
	function arp_navigation_section_array() {
		$arp_navigation_section_array = apply_filters(
			'arp_navigation_section_array',
			array(
				'arplitetemplate_1'  => array(
					'header_level' => array(
	...
	function arp_shortcode_custom_type() {
		$arp_shortcode_custom_type = apply_filters(
			'arp_shortcode_custom_type',
			array(
				'rounded'         => array(
	...
	function arp_custom_css_inner_sections() {
		$arp_custom_css_inner_sections = apply_filters(
			'arplite_custom_css_inner_sections',
			array(
				'arplitetemplate_1'  => array(),
				'arplitetemplate_2'  => array(
	...
	function arp_template_bg_section_inputs() {
		...
		$arp_tmp_bg_sec_inputs = apply_filters(
			'arp_tmp_bg_sec_inputs',
			array(
				'arplitetemplate_7'  => array(
					'caption_column' => array(),
					'other_column'   => array(
	...
	function arp_button_size_new() {
		$arp_button_size_new = apply_filters(
			'arplite_button_size_new',
			array(
				'Small'  => 'arp_small_btn',
	...
	function arp_column_bg_image_colors() {
		$arp_column_bg_image_colors = apply_filters(
			'arplite_column_bg_image_colors',
			array(
