...
if ( ! empty( $get_table_data ) ) {
	...
	wp_enqueue_style( 'google_font_ubuntu_url', $google_font_url, array(), $arpricelite_version );
?>
...
<div class="arp_ab_testing_main arplite_restricted_view">
	...
	<div class="arp_ab_testing_main_inner">
		<div class="arprice_ab_testing">
			...
			<?php if ( is_rtl() ) { ?>
				<span class="arp_ab_testing_shortcode <?php echo esc_attr( $shortcodeCls ); ?>">
				...
				<div class="arprice_ab_testing_inner_container">
					...
					<div class="arprice_ab_testing_primary_table_row">
						...
						<div class="arprice_ab_testing_row_input">
							...
							?>
							<input type="hidden" name="arprice_ab_testing_primary_table" id="arprice_ab_testing_primary_table" value="<?php echo esc_attr( $primary_table ); ?>" />
							<dl class="arprice_selectbox arplite_restricted_view" data-id="arprice_ab_testing_primary_table">
								<dt>
									<span><?php echo esc_html( $primary_table_name ); ?></span>
						...
						<div class="arprice_ab_testing_impression_wrapper">
							<div class="arprice_db_testing_impression_input_wrapper primary_tbl_prtg_wrap" >
								<input type="text" name="arp_ab_primary_tbl_impression" class="arprice_db_testing_primary_impression_input arp_numeric primary_tbl_prtg_wrap arplite_restricted_view" readonly="readonly" value="<?php echo esc_attr( $primary_table_impression ); ?>"/>
								<span>%</span>
							</div>
						</div>
						<!-- ////////////////// changelog -->
						...
						<div id="arprice_ab_testing_variation_tables">
							<div class="arprice_ab_testing_row_input_wrapper">
								...
								<?php if ( ! isset( $variation_tables ) || count( $variation_tables ) < 1 ) { ?>
									...
									<div class="arprice_ab_testing_row_input_wrapper">
									<div class="arprice_ab_testing_row_input">
										<input type="hidden" name="arprice_ab_testing_variation_table[]" id="arprice_ab_testing_variation_table_<?php echo esc_attr( $n ); ?>" value="<?php echo esc_html( $vtable_id ); ?>" />
										<dl class="arprice_selectbox" data-id="arprice_ab_testing_variation_table_<?php echo esc_attr( $n ); ?>">
											<dt>
												<span><?php echo esc_html( $variation_table_label ); ?></span>
												<svg viewBox="0 0 2000 1000" width="15px" height="15px"><g fill="#000000"><path d="M1024 320q0 -26 -19 -45t-45 -19h-896q-26 0 -45 19t-19 45t19 45l448 448q19 19 45 19t45 -19l448 -448q19 -19 19 -45z"></path></g></svg>
											</dt>
											<dd>
												<ul data-id="arprice_ab_testing_variation_table_<?php echo esc_attr( $n ); ?>">
													<li data-value="" data-label="<?php esc_html_e( 'Select Table', 'arprice-responsive-pricing-table' ); ?>"><?php esc_html_e( 'Select Table', 'arprice-responsive-pricing-table' ); ?></li>
												</ul>
											</dd>
										</dl>
									...
									<div class="arprice_ab_testing_impression_wrapper">
										<div class="arprice_db_testing_impression_input_wrapper">
											<input type="text" name="arprice_ab_testing_impression[]" data-row-id="<?php echo esc_html( $n ); ?>" class="arprice_db_testing_impression_input arp_numeric" value="<?php echo esc_html( $vtable_impression ); ?>" />
											<span>%</span>
										</div>
									</div>
									<div class="arprice_db_testing_action_button_wrapper">
										...
										if ( $n > 0 ) {
										?>
										<span id="arprice_remove_ab_testing_table" data-row-id="<?php echo esc_html($n); ?>" class="arprice_ab_testing_remove_button"><i class="far fa-trash-alt fa-lg"></i></span>
											<?php
										}
										?>
								</div>
